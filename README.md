...
[![Firefox Add-on](https://img.shields.io/badge/Firefox-Add--on-orange)](https://addons.mozilla.org/addon/youtube-rag-assistant/)
...
- **Stage 2 (Cross-Encoder):** Uses `cross-encoder/ms-marco-MiniLM-L-6-v2` to re-score those candidates. This ensures the most contextually relevant snippet is prioritized even if keywords don't match exactly.

### 3. Metadata-Augmented Citations
Each vector is tied to a `start_time` metadata attribute, allowing the extension to map AI-generated insights back to the source video coordinates in real-time.
...
- **Host URL:** `https://your-space-name.hf.space`
...
**[Download on Firefox Add-ons Store](https://addons.mozilla.org/addon/youtube-rag-assistant/)**
